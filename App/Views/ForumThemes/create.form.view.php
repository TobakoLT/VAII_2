        ...
        <div class="form-group row">
            ...
            <div class="col-12 col-md-9">
                <input type="text" class="form-control" id="title" name="title" placeholder="Zadajte názov"
                       minlength="3" maxlength="50" value="<?= $data->getNazov() ?>" required autofocus>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-12 col-md-9 mt-1">
                <textarea class="form-control" id="description" name="description" rows="3"
                          placeholder="Krátky popis čím sa daná téma zaoberá" required minlength="10"
                          maxlength="400"><?= $data->getPopis() ?></textarea>
            </div>
        </div>
        <div class="form-group row">
